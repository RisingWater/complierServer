...
export class SolutionComplierOptionFormTemplate extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            dataSource : [],
        ...
        var component = (
            <Form layout="vertical" onSubmit={this.onSubmit.bind(this)}>
                ...
                <Form.Item>
                    {getFieldDecorator(
                        'weixun_version',
                        {rules: [{ required: true, message: '请输入协议版本号' }]})
                        (<Input 
                            addonBefore="协议版本号" 
                            style={{width: 250}}
                            placeholder="请输入协议版本号"/>)
                    }
                </Form.Item>
                <Form.Item>
                    {getFieldDecorator(
                        'sep_version',
                        {rules: [{ required: true, message: '请输入SEP版本号' }]})
                        (<Input 
                            addonBefore="SEP版本号" 
                            style={{width: 250}}
                            placeholder="请输入SEP版本号"/>)
                    }
                </Form.Item>
